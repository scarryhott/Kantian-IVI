...
// Module: IVI.KantLimit
// Imports: Init IVI.Invariant IVI.Harmonics IVI.Kakeya
#include <lean/lean.h>
...
extern "C" {
#endif
LEAN_EXPORT lean_object* l_IVI_KantLimit_ctorIdx(lean_object*);
LEAN_EXPORT lean_object* l_IVI_KantLimit_ctorIdx(lean_object* x_1) {
_start:
{
lean_object* x_2; 
...
LEAN_EXPORT lean_object* initialize_IVI_KantLimit(uint8_t builtin, lean_object* w) {
lean_object * res;
